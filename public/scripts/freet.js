...
function editFreetAnon(fields) {
  fetch(`/api/freets/${fields.id}?isAnon=${fields.isAnon}`, {method: 'PUT', body: JSON.stringify(fields), headers: {'Content-Type': 'application/json'}})
    .then(showResponse)
    .catch(showResponse);
}
